...
export const portfolioItems: PortfolioItem[] = [
  ...
  },
  {
    ...
    category: 'creative',
    categoryLabel: 'Creative Content',
    image: '/images/portfolio/social-media/social-1.png',
    client: 'Brand Retail',
    year: 2024,
  ...
  },
  {
    ...
    category: 'photoshoot',
    categoryLabel: 'Photoshoot',
    image: '/images/portfolio/product-photo/product-1.png',
    client: 'Brand Lokal',
    year: 2024,
    href: '/portfolio#product-photo',
    featured: true,
  },
  {
    id: 'p3',
  ...
  {
    id: 'c3',
    title: 'Press Release Visual',
    category: 'creative',
    categoryLabel: 'Creative Content',
    image: '/images/portfolio/press-release/press-1.png',
    client: 'Brand Kuliner',
    year: 2024,
    href: '/portfolio#press-release',
  },
];
